...
export const bookingRepository = {
  ...
  // Lock booking fields required for session extension.
  ...
  // Fetch booking + assignment context for authorization checks.
  ...
  findCompanionAssignmentForBooking: (
    db: DbClient,
    input: { bookingId: string; companionId: string }
  ) =>
  ...
  updateBookingStatus: (db: DbClient, bookingId: string, status: "CANCELLED" | "COMPLETED") =>
    db.booking.update({
      where: { id: bookingId },
      data: { status },
