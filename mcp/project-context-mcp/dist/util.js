...
export function log(msg) {
    ...
    try {
        ...
        appendFileSync(MCP_USAGE_LOG, `${JSON.stringify({ timestamp: timestampGst, timestampGst, timestampUtc, server: "project-context-mcp", message: msg })}\n`);
    }
    catch {
